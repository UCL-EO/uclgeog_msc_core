#!/usr/bin/env python
"""Procuring datasets for uclgeog_msc_core
...
def procure_dataset(dataset_name, destination_folder="data",verbose=False,
                    locations=["/data/selene/ucfajlg/uclgeog_msc_core_data/",\
                               "/data/selene/ucfajlg/uclgeog_msc_core_data/lai_data/",\
                               "/archive/rsu_raid_0/plewis/public_html/uclgeog_msc_core_data"][::-1],\
                    ...
                    urls=["http://www2.geog.ucl.ac.uk/~ucfajlg/uclgeog_msc_core_data/",\
                          "http://www2.geog.ucl.ac.uk/~plewis/uclgeog_msc_core_data/",\
                          "http://www2.geog.ucl.ac.uk/~plewis/uclgeog_msc_core_data/lai_files/"][::-1]):
